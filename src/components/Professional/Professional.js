            ...
            <Container>
                <Row style={{ justifyContent: "center", padding: "10px" }}>
                    <h1 className="project-heading">
                        Education <strong className="purple">and </strong> Experiences
                    </h1>
                </Row>
            </Container>
            <Container>
                ...
                <Row style={{paddingBottom: "10px" }}>
                    <EducationCard
                        ...
                        tasksDone = {["Developed a large language model based companion mobile application that helps user's adapt sustainable mobile habits using Gemini 2.0, .NET MAUI, and .NET 9.0",
